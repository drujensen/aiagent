...
// Simple function to initialize message list on page load
// This preserves the formatting improvements but doesn't handle WebSocket updates
function updateMessageList(messages) {
    // This function is now only used for initial page load
    // The tool formatting logic is preserved in the templates
    // No WebSocket update logic needed
}
