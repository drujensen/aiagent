...
func NewGenericOpenAIIntegration(baseURL, apiKey, model string, toolRepo interfaces.ToolRepository, logger *zap.Logger) (*OpenAIIntegration, error) {
	return NewOpenAIIntegration(baseURL, apiKey, model, toolRepo, logger)
}

// ModelName returns the name of the model being used
func (m *OpenAIIntegration) ModelName() string {
	return m.model
}
...
// convertToAPIMessages converts message entities to the OpenAI API format
func convertToOpenAIMessages(messages []*entities.Message) []map[string]interface{} {
...
func (m *OpenAIIntegration) GenerateResponse(ctx context.Context, messages []*entities.Message, toolList []*interfaces.ToolIntegration, options map[string]interface{}) ([]*entities.Message, error) {
	...
	apiMessages := convertToOpenAIMessages(messages)
...
func (m *OpenAIIntegration) GetUsage() (*entities.Usage, error) {
	return m.lastUsage, nil
}

// Ensure OpenAIIntegration implements the AIModelIntegration interface
