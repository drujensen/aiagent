	...
	return []*entities.Provider{
		{
			...
			Models: []entities.ModelPricing{
				...
				{Name: "grok-2", InputPricePerMille: 2.00, OutputPricePerMille: 10.00, ContextWindow: 131072},
			},
		},
		{
		...
		},
		{
			...
			Models: []entities.ModelPricing{
				{Name: "claude-3-opus-latest", InputPricePerMille: 15.00, OutputPricePerMille: 75.00, ContextWindow: 200000},
	...
	return []entities.Agent{
		{
			...
			Tools:           []string{"File", "Search", "Bash", "Git", "Go", "Python", "Node", "Dotnet", "Find"},
			CreatedAt:       time.Now(),
			UpdatedAt:       time.Now(),
		},
		{
...
func DefaultTools() []*entities.ToolData {
	return []*entities.ToolData{
		...
		},
		{
			...
			Configuration: map[string]string{"mongo_collection": "mongodb://localhost:27017/aiagent"},
			CreatedAt:     time.Now(),
			UpdatedAt:     time.Now(),
		},
		{
